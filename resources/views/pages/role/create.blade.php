                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('role.store') }}" method="POST">
                                            ...
                                            <tr class="row pl-3">
                                                ...
                                                <td width="30%" style="vertical-align:top">
                                                    <div class="custom-control custom-checkbox mb-1">
                                                        <input type="checkbox" class="custom-control-input {{ $index }}" onclick="checkPermissionByGroupName('role_{{ $loop->index }}_management_td', this)" id="exampleCheckbox{{ $index }}" value="{{ $index }}">
                                                        <label class="custom-control-label" for="exampleCheckbox{{ $index }}">Select All</label>
                                                    </div>
                                                </td>
                                                <td style="vertical-align:top" class="role_{{ $loop->index }}_management_td">
                            ...
                            <button class="btn btn-primary waves-effect waves-float waves-light float-right mt-3" type="submit">{{ __('Submit') }}</button>
                        </form>
                    </div>
                </div>
            </div>
